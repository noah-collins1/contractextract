...
Return ONLY a single JSON object with this shape (no prose, no backticks):
...
def main():
    ...
    result = provider.extract(
        ...
        prompt=PROMPT,
        examples=EXAMPLES,
        extraction_passes=1,      # single pass is enough for a snippet
        max_workers=2,
        max_char_buffer=800
    )

    # Save an annotated doc + simple visualization so you can eyeball it
